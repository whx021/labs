...
int main() {
    ...
    117f:	e8 86 00 00 00       	call   120a <__x86.get_pc_thunk.ax>
    1184:	05 70 2e 00 00       	add    $0x2e70,%eax
    int a = 5;
    1189:	c7 45 fc 05 00 00 00 	movl   $0x5,-0x4(%ebp)
    unsigned int b = 5;
    1190:	c7 45 f8 05 00 00 00 	movl   $0x5,-0x8(%ebp)
    short c = 5;
    ...
    a = !a;
    11a4:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
    11a8:	0f 94 c0             	sete   %al
    11ab:	0f b6 c0             	movzbl %al,%eax
    11ae:	89 45 fc             	mov    %eax,-0x4(%ebp)
    b = !b;
    11b1:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    11b5:	0f 94 c0             	sete   %al
    11b8:	0f b6 c0             	movzbl %al,%eax
    11bb:	89 45 f8             	mov    %eax,-0x8(%ebp)
    c = !c;
    11be:	66 83 7d f6 00       	cmpw   $0x0,-0xa(%ebp)
    11c3:	0f 94 c0             	sete   %al
    11c6:	0f b6 c0             	movzbl %al,%eax
    11c9:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
    d = a && b;
    11cd:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
    11d1:	74 0d                	je     11e0 <main+0x67>
    11d3:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    11d7:	74 07                	je     11e0 <main+0x67>
    11d9:	b8 01 00 00 00       	mov    $0x1,%eax
    11de:	eb 05                	jmp    11e5 <main+0x6c>
    11e0:	b8 00 00 00 00       	mov    $0x0,%eax
    11e5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    d = a || b;
    11e8:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
    11ec:	75 06                	jne    11f4 <main+0x7b>
    11ee:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
    11f2:	74 07                	je     11fb <main+0x82>
    11f4:	b8 01 00 00 00       	mov    $0x1,%eax
    11f9:	eb 05                	jmp    1200 <main+0x87>
...
0000120a <__x86.get_pc_thunk.ax>:
    120a:	8b 04 24             	mov    (%esp),%eax
    120d:	c3                   	ret
...
00001210 <_fini>:
    ...
    1214:	e8 67 fe ff ff       	call   1080 <__x86.get_pc_thunk.bx>
