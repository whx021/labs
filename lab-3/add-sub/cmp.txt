...
int main(int argc, char **argv) {
    ...
    int x = 4, y = 10;
    11a6:	c7 45 f4 04 00 00 00 	movl   $0x4,-0xc(%ebp)
    11ad:	c7 45 f0 0a 00 00 00 	movl   $0xa,-0x10(%ebp)
    while (x <= y) {
    11b4:	eb 12                	jmp    11c8 <main+0x3f>
        printf("ok");
    11b6:	83 ec 0c             	sub    $0xc,%esp
    11b9:	8d 83 14 e0 ff ff    	lea    -0x1fec(%ebx),%eax
    11bf:	50                   	push   %eax
    11c0:	e8 7b fe ff ff       	call   1040 <printf@plt>
    11c5:	83 c4 10             	add    $0x10,%esp
    while (x <= y) {
    11c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    11cb:	3b 45 f0             	cmp    -0x10(%ebp),%eax
    11ce:	7e e6                	jle    11b6 <main+0x2d>
    }
    if (x < y) {
    11d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    11d3:	3b 45 f0             	cmp    -0x10(%ebp),%eax
    11d6:	7d 12                	jge    11ea <main+0x61>
        printf("okok");
    11d8:	83 ec 0c             	sub    $0xc,%esp
    11db:	8d 83 17 e0 ff ff    	lea    -0x1fe9(%ebx),%eax
    11e1:	50                   	push   %eax
    11e2:	e8 59 fe ff ff       	call   1040 <printf@plt>
    11e7:	83 c4 10             	add    $0x10,%esp
    }
    return 0;
    11ea:	b8 00 00 00 00       	mov    $0x0,%eax
}
    11ef:	8d 65 f8             	lea    -0x8(%ebp),%esp
    11f2:	59                   	pop    %ecx
    11f3:	5b                   	pop    %ebx
    11f4:	5d                   	pop    %ebp
    11f5:	8d 61 fc             	lea    -0x4(%ecx),%esp
    11f8:	c3                   	ret
...
000011fc <_fini>:
    ...
    1200:	e8 8b fe ff ff       	call   1090 <__x86.get_pc_thunk.bx>
    1205:	81 c3 ef 2d 00 00    	add    $0x2def,%ebx
