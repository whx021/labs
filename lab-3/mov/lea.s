...
int main(int argc, char **argv) {
    ...
    119b:	e8 3f 00 00 00       	call   11df <__x86.get_pc_thunk.ax>
    11a0:	05 54 2e 00 00       	add    $0x2e54,%eax
    int i = 3, j = 4;
    11a5:	c7 45 f4 03 00 00 00 	movl   $0x3,-0xc(%ebp)
    11ac:	c7 45 f0 04 00 00 00 	movl   $0x4,-0x10(%ebp)
    asm (
    11b3:	8b 55 f4             	mov    -0xc(%ebp),%edx
    11b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    11b9:	8d 04 02             	lea    (%edx,%eax,1),%eax
        "mov    -0xc(%ebp), %edx\n\t" // i -> edx
        "mov    -0x10(%ebp), %eax\n\t"
        "lea    (%edx, %eax, 1), %eax\n\t"
    );
    ...
    11bf:	8d 90 14 e0 ff ff    	lea    -0x1fec(%eax),%edx
    11c5:	52                   	push   %edx
    ...
    11d5:	8d 65 f8             	lea    -0x8(%ebp),%esp
    11d8:	59                   	pop    %ecx
    11d9:	5b                   	pop    %ebx
    11da:	5d                   	pop    %ebp
    11db:	8d 61 fc             	lea    -0x4(%ecx),%esp
    11de:	c3                   	ret

000011df <__x86.get_pc_thunk.ax>:
    11df:	8b 04 24             	mov    (%esp),%eax
    11e2:	c3                   	ret
...
000011e4 <_fini>:
    ...
    11ed:	81 c3 07 2e 00 00    	add    $0x2e07,%ebx
