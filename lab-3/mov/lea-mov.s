...
lea-mov:     file format elf32-i386
...
int main(int argc, char **argv) {
    ...
    119b:	e8 49 00 00 00       	call   11e9 <__x86.get_pc_thunk.ax>
    11a0:	05 54 2e 00 00       	add    $0x2e54,%eax
    int p[2] = {0x12345678, 0x11223344};
    11a5:	c7 45 f0 78 56 34 12 	movl   $0x12345678,-0x10(%ebp)
    11ac:	c7 45 f4 44 33 22 11 	movl   $0x11223344,-0xc(%ebp)
    asm(
    11b3:	8d 45 f0             	lea    -0x10(%ebp),%eax
    11b6:	8b 5d f0             	mov    -0x10(%ebp),%ebx
    11b9:	b9 01 00 00 00       	mov    $0x1,%ecx
    11be:	8d 44 8d f0          	lea    -0x10(%ebp,%ecx,4),%eax
    11c2:	8b 5c 8d f0          	mov    -0x10(%ebp,%ecx,4),%ebx
        "mov    -0x10(%ebp), %ebx\n\t"
        "mov    $1, %ecx\n\t"
    ...
    11c9:	8d 90 14 e0 ff ff    	lea    -0x1fec(%eax),%edx
    11cf:	52                   	push   %edx
    11d0:	89 c3                	mov    %eax,%ebx
    11d2:	e8 69 fe ff ff       	call   1040 <printf@plt>
    11d7:	83 c4 10             	add    $0x10,%esp
    return 0;
    11da:	b8 00 00 00 00       	mov    $0x0,%eax
}
    11df:	8d 65 f8             	lea    -0x8(%ebp),%esp
    11e2:	59                   	pop    %ecx
    11e3:	5b                   	pop    %ebx
    11e4:	5d                   	pop    %ebp
    11e5:	8d 61 fc             	lea    -0x4(%ecx),%esp
    11e8:	c3                   	ret
...
000011f0 <_fini>:
    ...
    11f4:	e8 97 fe ff ff       	call   1090 <__x86.get_pc_thunk.bx>
    11f9:	81 c3 fb 2d 00 00    	add    $0x2dfb,%ebx
    11ff:	83 c4 08             	add    $0x8,%esp
    1202:	5b                   	pop    %ebx
    1203:	c3                   	ret
