...
int main(int argc, char **argv) {
    ...
    11a6:	c7 45 f4 64 00 00 00 	movl   $0x64,-0xc(%ebp)
    11ad:	c7 45 f0 00 00 00 80 	movl   $0x80000000,-0x10(%ebp)
    11b4:	c7 45 ec 9c ff ff ff 	movl   $0xffffff9c,-0x14(%ebp)
    unsigned au = 100, bu = 2147483648, cu = -100;
    11bb:	c7 45 e8 64 00 00 00 	movl   $0x64,-0x18(%ebp)
    11c2:	c7 45 e4 00 00 00 80 	movl   $0x80000000,-0x1c(%ebp)
    11c9:	c7 45 e0 9c ff ff ff 	movl   $0xffffff9c,-0x20(%ebp)
    printf("ai = %d, bi = %d, ci = %d\n", ai, bi, ci);
    11d0:	ff 75 ec             	push   -0x14(%ebp)
    11d3:	ff 75 f0             	push   -0x10(%ebp)
    11d6:	ff 75 f4             	push   -0xc(%ebp)
    11d9:	8d 83 14 e0 ff ff    	lea    -0x1fec(%ebx),%eax
    11df:	50                   	push   %eax
    11e0:	e8 5b fe ff ff       	call   1040 <printf@plt>
    11e5:	83 c4 10             	add    $0x10,%esp
    printf("au = %u, bu = %u, cu = %u\n", au, bu, cu);
    11e8:	ff 75 e0             	push   -0x20(%ebp)
    11eb:	ff 75 e4             	push   -0x1c(%ebp)
    11ee:	ff 75 e8             	push   -0x18(%ebp)
    11f1:	8d 83 2f e0 ff ff    	lea    -0x1fd1(%ebx),%eax
    11f7:	50                   	push   %eax
    11f8:	e8 43 fe ff ff       	call   1040 <printf@plt>
...
00001210 <_fini>:
    ...
    1214:	e8 77 fe ff ff       	call   1090 <__x86.get_pc_thunk.bx>
    1219:	81 c3 db 2d 00 00    	add    $0x2ddb,%ebx
    121f:	83 c4 08             	add    $0x8,%esp
    1222:	5b                   	pop    %ebx
    1223:	c3                   	ret
