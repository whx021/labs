...
int fn(unsigned int n) {
    ...
    118f:	e8 89 00 00 00       	call   121d <__x86.get_pc_thunk.ax>
    1194:	05 60 2e 00 00       	add    $0x2e60,%eax
    int sum = 1, power = 1;
    1199:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%ebp)
    11a0:	c7 45 f8 01 00 00 00 	movl   $0x1,-0x8(%ebp)
    int i;
    for (i = 0; i <= n - 1; ++i) {
    11a7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    11ae:	eb 0d                	jmp    11bd <fn+0x34>
        power *= 2;
    11b0:	d1 65 f8             	shll   -0x8(%ebp)
        sum += power;
    11b3:	8b 45 f8             	mov    -0x8(%ebp),%eax
    11b6:	01 45 fc             	add    %eax,-0x4(%ebp)
    for (i = 0; i <= n - 1; ++i) {
    11b9:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    11bd:	8b 45 08             	mov    0x8(%ebp),%eax
    11c0:	8d 50 ff             	lea    -0x1(%eax),%edx
    11c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
    11c6:	39 c2                	cmp    %eax,%edx
    11c8:	73 e6                	jae    11b0 <fn+0x27>
    }
    return sum;
...
int main(int argc, char **argv) {
    11cf:	8d 4c 24 04          	lea    0x4(%esp),%ecx
    11d3:	83 e4 f0             	and    $0xfffffff0,%esp
    11d6:	ff 71 fc             	push   -0x4(%ecx)
    11d9:	55                   	push   %ebp
    11da:	89 e5                	mov    %esp,%ebp
    11dc:	53                   	push   %ebx
    11dd:	51                   	push   %ecx
    11de:	83 ec 10             	sub    $0x10,%esp
    11e1:	e8 aa fe ff ff       	call   1090 <__x86.get_pc_thunk.bx>
    11e6:	81 c3 0e 2e 00 00    	add    $0x2e0e,%ebx
    int sum;
    sum = fn(0);
    11ec:	6a 00                	push   $0x0
    11ee:	e8 96 ff ff ff       	call   1189 <fn>
    11f3:	83 c4 04             	add    $0x4,%esp
    11f6:	89 45 f4             	mov    %eax,-0xc(%ebp)
    printf("sum = %d\n", sum);
    11f9:	83 ec 08             	sub    $0x8,%esp
    11fc:	ff 75 f4             	push   -0xc(%ebp)
    11ff:	8d 83 14 e0 ff ff    	lea    -0x1fec(%ebx),%eax
    1205:	50                   	push   %eax
    ...
    1213:	8d 65 f8             	lea    -0x8(%ebp),%esp
    1216:	59                   	pop    %ecx
    1217:	5b                   	pop    %ebx
    1218:	5d                   	pop    %ebp
    1219:	8d 61 fc             	lea    -0x4(%ecx),%esp
    121c:	c3                   	ret

0000121d <__x86.get_pc_thunk.ax>:
    121d:	8b 04 24             	mov    (%esp),%eax
    1220:	c3                   	ret
