...
int fn(int n) {
    ...
    118f:	e8 84 00 00 00       	call   1218 <__x86.get_pc_thunk.ax>
    ...
    11c0:	3b 45 f4             	cmp    -0xc(%ebp),%eax
    11c3:	7f eb                	jg     11b0 <fn+0x27>
    }
    return sum;
...
int main(int argc, char **argv) {
    11ca:	8d 4c 24 04          	lea    0x4(%esp),%ecx
    11ce:	83 e4 f0             	and    $0xfffffff0,%esp
    11d1:	ff 71 fc             	push   -0x4(%ecx)
    11d4:	55                   	push   %ebp
    11d5:	89 e5                	mov    %esp,%ebp
    11d7:	53                   	push   %ebx
    11d8:	51                   	push   %ecx
    11d9:	83 ec 10             	sub    $0x10,%esp
    11dc:	e8 af fe ff ff       	call   1090 <__x86.get_pc_thunk.bx>
    11e1:	81 c3 13 2e 00 00    	add    $0x2e13,%ebx
    int sum;
    sum = fn(0);
    11e7:	6a 00                	push   $0x0
    11e9:	e8 9b ff ff ff       	call   1189 <fn>
    11ee:	83 c4 04             	add    $0x4,%esp
...
0000121c <_fini>:
    ...
    1220:	e8 6b fe ff ff       	call   1090 <__x86.get_pc_thunk.bx>
    1225:	81 c3 cf 2d 00 00    	add    $0x2dcf,%ebx
    122b:	83 c4 08             	add    $0x8,%esp
    122e:	5b                   	pop    %ebx
    122f:	c3                   	ret
