...
integer:     file format elf32-i386
...
int main(int argc, char **argv) {
    ...
    short           si = -100;
    11a6:	66 c7 45 f6 9c ff    	movw   $0xff9c,-0xa(%ebp)
    unsigned short  usi = si;
    11ac:	0f b7 45 f6          	movzwl -0xa(%ebp),%eax
    11b0:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
    int             i = usi;
    11b4:	0f b7 45 f4          	movzwl -0xc(%ebp),%eax
    11b8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    unsigned        ui = usi;
    11bb:	0f b7 45 f4          	movzwl -0xc(%ebp),%eax
    11bf:	89 45 ec             	mov    %eax,-0x14(%ebp)
    int             i1 = si;
    11c2:	0f bf 45 f6          	movswl -0xa(%ebp),%eax
    11c6:	89 45 e8             	mov    %eax,-0x18(%ebp)
    unsigned        ui1 = si;
    11c9:	0f bf 45 f6          	movswl -0xa(%ebp),%eax
    11cd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    int             i2 = 0x12345678;
    11d0:	c7 45 e0 78 56 34 12 	movl   $0x12345678,-0x20(%ebp)
    short           si2 = i2;
    11d7:	8b 45 e0             	mov    -0x20(%ebp),%eax
    11da:	66 89 45 de          	mov    %ax,-0x22(%ebp)
    unsigned short  usi2 = i2;
    11de:	8b 45 e0             	mov    -0x20(%ebp),%eax
    11e1:	66 89 45 dc          	mov    %ax,-0x24(%ebp)
    int             i3 = si2;
    11e5:	0f bf 45 de          	movswl -0x22(%ebp),%eax
    11e9:	89 45 d8             	mov    %eax,-0x28(%ebp)
    int             i4 = 4294967296;
    11ec:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
    printf("si = %d, usi = %u, i = %d, ui = %u, i1 = %d, ui1 = %u\n", si, usi, i, ui, i1, ui1);
    11f3:	0f b7 55 f4          	movzwl -0xc(%ebp),%edx
    11f7:	0f bf 45 f6          	movswl -0xa(%ebp),%eax
    11fb:	83 ec 04             	sub    $0x4,%esp
    11fe:	ff 75 e4             	push   -0x1c(%ebp)
    1201:	ff 75 e8             	push   -0x18(%ebp)
    1204:	ff 75 ec             	push   -0x14(%ebp)
    1207:	ff 75 f0             	push   -0x10(%ebp)
    120a:	52                   	push   %edx
    120b:	50                   	push   %eax
    120c:	8d 83 14 e0 ff ff    	lea    -0x1fec(%ebx),%eax
    1212:	50                   	push   %eax
    1213:	e8 28 fe ff ff       	call   1040 <printf@plt>
    1218:	83 c4 20             	add    $0x20,%esp
    printf("i2 = %d, si2 = %d, usi2 = %u, i3 = %d, i4 = %d\n", i2, si2, usi2, i3, i4);
    121b:	0f b7 55 dc          	movzwl -0x24(%ebp),%edx
    121f:	0f bf 45 de          	movswl -0x22(%ebp),%eax
    1223:	83 ec 08             	sub    $0x8,%esp
    1226:	ff 75 d4             	push   -0x2c(%ebp)
    1229:	ff 75 d8             	push   -0x28(%ebp)
    122c:	52                   	push   %edx
    122d:	50                   	push   %eax
    122e:	ff 75 e0             	push   -0x20(%ebp)
    1231:	8d 83 4c e0 ff ff    	lea    -0x1fb4(%ebx),%eax
    1237:	50                   	push   %eax
    1238:	e8 03 fe ff ff       	call   1040 <printf@plt>
    123d:	83 c4 20             	add    $0x20,%esp
    return 0;
    1240:	b8 00 00 00 00       	mov    $0x0,%eax
}
    1245:	8d 65 f8             	lea    -0x8(%ebp),%esp
    1248:	59                   	pop    %ecx
    1249:	5b                   	pop    %ebx
    124a:	5d                   	pop    %ebp
    124b:	8d 61 fc             	lea    -0x4(%ecx),%esp
    124e:	c3                   	ret
...
00001250 <_fini>:
    ...
    1254:	e8 37 fe ff ff       	call   1090 <__x86.get_pc_thunk.bx>
    1259:	81 c3 9b 2d 00 00    	add    $0x2d9b,%ebx
