...
alignment:     file format elf32-i386
...
int main(int argc, char **argv) {
    ...
    119b:	e8 52 00 00 00       	call   11f2 <__x86.get_pc_thunk.ax>
    ...
    11a5:	c6 45 e0 01          	movb   $0x1,-0x20(%ebp)
    11a9:	c7 45 e4 02 00 00 00 	movl   $0x2,-0x1c(%ebp)
    11b0:	66 c7 45 e8 03 00    	movw   $0x3,-0x18(%ebp)
    11b6:	c6 45 ea 04          	movb   $0x4,-0x16(%ebp)
    R[1].a = 5; R[1].b = 6; R[0].c = 7; R[1].d = 8;
    11ba:	c6 45 ec 05          	movb   $0x5,-0x14(%ebp)
    11be:	c7 45 f0 06 00 00 00 	movl   $0x6,-0x10(%ebp)
    11c5:	66 c7 45 e8 07 00    	movw   $0x7,-0x18(%ebp)
    11cb:	c6 45 f6 08          	movb   $0x8,-0xa(%ebp)
    printf("Boundary alignment during data storage");
    11cf:	83 ec 0c             	sub    $0xc,%esp
    11d2:	8d 90 14 e0 ff ff    	lea    -0x1fec(%eax),%edx
    11d8:	52                   	push   %edx
...
000011f2 <__x86.get_pc_thunk.ax>:
    11f2:	8b 04 24             	mov    (%esp),%eax
    11f5:	c3                   	ret
...
000011f8 <_fini>:
    ...
    11fc:	e8 8f fe ff ff       	call   1090 <__x86.get_pc_thunk.bx>
    1201:	81 c3 f3 2d 00 00    	add    $0x2df3,%ebx
    1207:	83 c4 08             	add    $0x8,%esp
    120a:	5b                   	pop    %ebx
    120b:	c3                   	ret
