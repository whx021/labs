...
int-add-sub:     file format elf32-i386
...
int main(int argc, char ** argv) {
    ...
    11a6:	c7 45 f4 32 54 76 98 	movl   $0x98765432,-0xc(%ebp)
    11ad:	c7 45 f0 21 43 65 87 	movl   $0x87654321,-0x10(%ebp)
    unsigned int ua = 0x98765432, ub = 0x87654321, uc, ud;
    11b4:	c7 45 ec 32 54 76 98 	movl   $0x98765432,-0x14(%ebp)
    11bb:	c7 45 e8 21 43 65 87 	movl   $0x87654321,-0x18(%ebp)
    c = a + b;  uc = ua + ub;
    11c2:	8b 55 f4             	mov    -0xc(%ebp),%edx
    11c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    11c8:	01 d0                	add    %edx,%eax
    11ca:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    11cd:	8b 55 ec             	mov    -0x14(%ebp),%edx
    11d0:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11d3:	01 d0                	add    %edx,%eax
    11d5:	89 45 e0             	mov    %eax,-0x20(%ebp)
    d = a - b;  ud = ua - ub;
    11d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    11db:	2b 45 f0             	sub    -0x10(%ebp),%eax
    11de:	89 45 dc             	mov    %eax,-0x24(%ebp)
    11e1:	8b 45 ec             	mov    -0x14(%ebp),%eax
    11e4:	2b 45 e8             	sub    -0x18(%ebp),%eax
    11e7:	89 45 d8             	mov    %eax,-0x28(%ebp)
    printf("%d + (%d) = %d\n", a, b, c);
    11ea:	ff 75 e4             	push   -0x1c(%ebp)
    11ed:	ff 75 f0             	push   -0x10(%ebp)
    11f0:	ff 75 f4             	push   -0xc(%ebp)
    11f3:	8d 83 14 e0 ff ff    	lea    -0x1fec(%ebx),%eax
    11f9:	50                   	push   %eax
    11fa:	e8 41 fe ff ff       	call   1040 <printf@plt>
    11ff:	83 c4 10             	add    $0x10,%esp
    printf("%u + %u = %u\n", ua, ub, uc);
    1202:	ff 75 e0             	push   -0x20(%ebp)
    1205:	ff 75 e8             	push   -0x18(%ebp)
    1208:	ff 75 ec             	push   -0x14(%ebp)
    120b:	8d 83 24 e0 ff ff    	lea    -0x1fdc(%ebx),%eax
    1211:	50                   	push   %eax
    1212:	e8 29 fe ff ff       	call   1040 <printf@plt>
    1217:	83 c4 10             	add    $0x10,%esp
    printf("%d - (%d) = %d\n", a, b, d);
    121a:	ff 75 dc             	push   -0x24(%ebp)
    121d:	ff 75 f0             	push   -0x10(%ebp)
    1220:	ff 75 f4             	push   -0xc(%ebp)
    1223:	8d 83 32 e0 ff ff    	lea    -0x1fce(%ebx),%eax
    1229:	50                   	push   %eax
    122a:	e8 11 fe ff ff       	call   1040 <printf@plt>
    122f:	83 c4 10             	add    $0x10,%esp
    printf("%u - %u = %u\n", ua, ub, ud);
    1232:	ff 75 d8             	push   -0x28(%ebp)
    1235:	ff 75 e8             	push   -0x18(%ebp)
    1238:	ff 75 ec             	push   -0x14(%ebp)
    123b:	8d 83 42 e0 ff ff    	lea    -0x1fbe(%ebx),%eax
    1241:	50                   	push   %eax
    1242:	e8 f9 fd ff ff       	call   1040 <printf@plt>
    1247:	83 c4 10             	add    $0x10,%esp
    return 0;
    124a:	b8 00 00 00 00       	mov    $0x0,%eax
}
    124f:	8d 65 f8             	lea    -0x8(%ebp),%esp
    1252:	59                   	pop    %ecx
    1253:	5b                   	pop    %ebx
    1254:	5d                   	pop    %ebp
    1255:	8d 61 fc             	lea    -0x4(%ecx),%esp
    1258:	c3                   	ret
...
0000125c <_fini>:
    ...
    1260:	e8 2b fe ff ff       	call   1090 <__x86.get_pc_thunk.bx>
    1265:	81 c3 8f 2d 00 00    	add    $0x2d8f,%ebx
    126b:	83 c4 08             	add    $0x8,%esp
    126e:	5b                   	pop    %ebx
    126f:	c3                   	ret
